...
namespace Data.Database
{
    public class EspecialidadAdapter : Adapter
    {
        ...
        public Especialidad GetOne(int ID)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdEspecialidad = new SqlCommand("Select * from especialidades where id_especialidad = @id", sqlConnection);
        ...
        protected void Update(Especialidad especialidad)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdSave = new SqlCommand("UPDATE especialidades SET desc_especialidad=@desc_especialidad where id_especialidad=@id", sqlConnection);
        ...
        protected void Insert(Especialidad especialidad)
        {
            try
            {
                ...
                "Values(@desc_especialidad)", sqlConnection);
                cmdSave.Parameters.Add("@desc_especialidad", SqlDbType.VarChar, 50).Value = especialidad.DescEspecialidad;
                cmdSave.ExecuteNonQuery();
            }
            catch (Exception Ex)
