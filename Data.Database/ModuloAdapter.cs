...
namespace Data.Database
{
    public class ModuloAdapter : Adapter
    {
        ...
        public List<Modulo> GetAll()
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdModulos = new SqlCommand("select * from modulos", sqlConnection);
        ...
        public Modulo GetOne(int ID)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdModulos = new SqlCommand("Select * from modulos where id_modulo = @id", sqlConnection);
        ...
        protected void Update(Modulo modulo)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdSave = new SqlCommand("UPDATE modulos SET desc_modulo=@desc_modulo, ejecuta=@ejecuta where id_modulo=@id", sqlConnection);
        ...
        public void Delete(int ID)
        {
            try
            {
                ...
                SqlCommand cmdDelete = new SqlCommand("delete modulos where id_modulo=@id", sqlConnection);
        ...
        protected void Insert(Modulo modulo)
        {
            try
            {
                ...
                "Values(@desc_modulo,@ejecuta)", sqlConnection);
                cmdSave.Parameters.Add("@desc_modulo", SqlDbType.VarChar, 50).Value = modulo.DescModulo;
                cmdSave.Parameters.Add("@ejecuta", SqlDbType.VarChar, 50).Value = modulo.Ejecuta;
                cmdSave.ExecuteNonQuery();
            }
